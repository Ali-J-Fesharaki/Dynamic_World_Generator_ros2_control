...
class PegasusApp:
    ...
    def __init__(self):
        ...
        # Acquire the World, i.e., the singleton that controls that is a one stop shop for getting
        # the physics context, the stage, etc.
        ...
        # Create a person with the circle controller
        Person(
            "person1",
        ...
        # Auxiliary variable for the user to quit the simulation
    ...
    def run(self):
        ...
        # The "infinite" loop
        while simulation_app.is_running() and self._is_running:

            # Update the UI of the app and perform the physics step
            self.world.step(render=True)

        # Cleanup and stop
        carb.log_warn("PegasusApp has terminated")
        self.timeline.stop()
...
def main():
    ...
    """
    # Instantiate the PegasusApp template
    pg_app = PegasusApp()
